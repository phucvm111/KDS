...
// * @author admin
// */
//@WebServlet(name = "GraduateServlet", urlPatterns = {"/graduate"})
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet GraduateServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet GraduateServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
...
//
//            response.sendRedirect("admin/kinder/students-studying.jsp");
//
//        } catch (Exception e) {
//            e.printStackTrace();
