...
public class tutitionfreeServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<TutitionFree> tf=td.getAlltutition();
        for(TutitionFree tt:tf){
        
        accounts.add(ad.getAccountByID(tt.getKinder().getParent_id()));
        }
        request.setAttribute("accounts", accounts);
        
        
            if(tf!=null){
                request.setAttribute("tutitionfrees", tf);
