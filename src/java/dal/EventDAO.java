...
public class EventDAO extends DBContext { 
    ...
    public List<Event> getAllEvents(String searchTitle) { 
        ...
        try {
            ...
            Logger.getLogger(EventDAO.class.getName()).log(Level.SEVERE, "SQL Error when getting all events with search", e);
        } catch (Exception e) { 
            Logger.getLogger(EventDAO.class.getName()).log(Level.SEVERE, "Error when getting all events with search", e);
        } finally {
            try {
                if (rs != null) rs.close();
                if (ps != null) ps.close();
