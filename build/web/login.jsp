        ...
        <div class="container" id="container">
            <div class="form-container sign-in-container">
                <form action="login" method="POST">
                    ...
                    <input type="text" id="login" name="email" placeholder="Email" required="" value="${email}"/><br />
                    <input type="password" id="password" name="password" placeholder="Password" value="${password}" required=""/><br />
                    <!--<br />-->
                    ...
                    <button>Sign In</button>
                     <a href="ForgetPassword.jsp" style="color: blue; text-decoration: underline;">Forget Password</a>
